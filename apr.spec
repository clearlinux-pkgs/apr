...
Source0  : https://archive.apache.org/dist/apr/apr-1.7.4.tar.gz
Source1  : https://archive.apache.org/dist/apr/apr-1.7.4.tar.gz.asc
...
%prep
%setup -q -n apr-1.7.4
cd %{_builddir}/apr-1.7.4
%patch -P 1 -p1
pushd ..
cp -a apr-1.7.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704763783
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libapr-1.so.0.7.4

...
Version  : 1.7.1
Release  : 48
URL      : https://www.apache.org/dist/apr/apr-1.7.1.tar.gz
Source0  : https://www.apache.org/dist/apr/apr-1.7.1.tar.gz
Source1  : https://www.apache.org/dist/apr/apr-1.7.1.tar.gz.asc
...
%prep
%setup -q -n apr-1.7.1-rc2
cd %{_builddir}/apr-1.7.1-rc2
%patch1 -p1
pushd ..
cp -a apr-1.7.1-rc2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675181603
...
cp %{_builddir}/apr-%{version}-rc2/LICENSE %{buildroot}/usr/share/package-licenses/apr/2eae3e0a27a2e49e86a350c94513de0ddb1d2c98 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libapr-1.so.0.7.1
/usr/lib64/libapr-1.so.0
/usr/lib64/libapr-1.so.0.7.1
